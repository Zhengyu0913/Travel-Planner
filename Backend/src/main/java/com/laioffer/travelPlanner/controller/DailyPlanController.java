...
public class DailyPlanController {
     ...
     * 基于daily_plan_id
     */
    @RequestMapping(value = "/api/daily_plan/{daily_plan_id}/place_entry", method = RequestMethod.DELETE)
     ...
     */
    @RequestMapping(value = "/api/daily_plan/{daily_plan_id}/place_entry/{time_block}", method = RequestMethod.DELETE)
     ...
     */
    @RequestMapping(value = "/api/daily_plan", method = RequestMethod.POST)
     ...
     */
    @RequestMapping(value = "/api/daily_plan/{daily_plan_id}", method = RequestMethod.GET)
    @ResponseBody
     ...
     * (涉及更改trip日期)
     */
    @RequestMapping(value = "/api/daily_plan/{daily_plan_id}", method = RequestMethod.DELETE)
